...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativeRatio
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativePartialRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativeTokenSortRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativePartialTokenSortRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativeTokenSetRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativePartialTokenSetRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativeTokenRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativePartialTokenRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativeWeightedRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
...
JNIEXPORT jdouble JNICALL Java_id_panicdev_rapidfuzz_RapidFuzz_nativeQuickRatio
  (JNIEnv *env, jclass clazz, jstring s1, jstring s2, jdouble score_cuttoff) {
    const char* str1 = env->GetStringUTFChars(s1, NULL);
    const char* str2 = env->GetStringUTFChars(s2, NULL);
