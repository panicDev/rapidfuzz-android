...
class FuzzyWuzzyTest {
    ...
    val moreChoices =
        listOf("Atlanta Falcons", "New York Jets", "New York Giants", "Dallas Cowboys")
    ...
    fun testTokenSortPartial() {
        ...
        assertEquals(
            44,
            FuzzySearch.tokenSortPartialRatio("Testing token set ratio token", "Added another test")
        )
    ...
    fun testTokenSetRatio() {
        ...
        assertEquals(
            39,
            FuzzySearch.tokenSetRatio("Testing token set ratio token", "Added another test")
        )
    ...
    fun testWeightedRatio() {
        ...
        assertEquals(
            40,
            FuzzySearch.weightedRatio("mvn", "www'l34.423.4/23.4/234//////www.mavencentral.comm")
        )
        assertEquals(
            97, FuzzySearch.weightedRatio(
